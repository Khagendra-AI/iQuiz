...
const Quiz3 = ({navigation}:{navigation:any}) => {
  const opArray=['+','-','*','/']
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Question 3</Text>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.optionView}>
          <TouchableOpacity style={styles.optionTouchable} onPress={onOption1Press}><Text style={styles.optionText}>{result(`${x}${operator}${y}+1`)}</Text></TouchableOpacity>
          ...
          <TouchableOpacity style={styles.optionTouchable} onPress={onOption3Press}><Text style={styles.optionText}>{result(`${x}${operator}${y}`)}</Text></TouchableOpacity>
          <TouchableOpacity style={styles.optionTouchable} onPress={onOption4Press}><Text style={styles.optionText}>{result(`${x}${operator}${y}+2`)}</Text></TouchableOpacity>
        </View>
