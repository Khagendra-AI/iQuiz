...
const Quiz4 = ({navigation}:{navigation:any}) => {
  const opArray=['+','-','*','/']
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Question 4</Text>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.optionView}>
          <TouchableOpacity style={styles.optionTouchable} onPress={onOption1Press}><Text style={styles.optionText}>{result(`${x}${operator}${y}`)}</Text></TouchableOpacity>
